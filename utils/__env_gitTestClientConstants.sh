...
readonly __GIT_CLIENT_USERNAME="gittest"
readonly __GIT_CLIENT_NAME="gittestclient"
...
readonly __GIT_CLIENT_IMAGE_NAME="gittestclient"
readonly __GIT_CLIENT_IMAGE_VERSION="1.0.0"
readonly __GIT_CLIENT_HOST_NAME="gittestclient"
readonly __GIT_CLIENT_CONTAINER_NAME="gittestclient"
